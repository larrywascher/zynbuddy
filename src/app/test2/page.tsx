...
export default function Test2Page() {
  ...
  return (
    <div style={{ height: "100vh", display: "flex", flexDirection: "column" }}>
      <div style={{ padding: "12px 16px", background: "#7c3aed", display: "flex", gap: 8, alignItems: "center" }}>
        <span style={{ color: "white", fontWeight: 700, fontSize: 14, marginRight: 8 }}>Test 2: MapLibre GL + OpenFreeMap</span>
        <form onSubmit={handleSearch} style={{ flex: 1, display: "flex", gap: 8 }}>
          ...
          />
          <button type="submit" style={{ padding: "8px 16px", background: "white", color: "#7c3aed", borderRadius: 8, border: "none", fontWeight: 700, fontSize: 14, cursor: "pointer" }}>Go</button>
        </form>
        <a href="/test1" style={{ color: "white", fontSize: 12, textDecoration: "underline" }}>&larr; Test 1</a>
      ...
      <div style={{ padding: "6px 16px", background: "#f1f5f9", fontSize: 11, color: "#64748b", textAlign: "center" }}>
        MapLibre GL JS + OpenFreeMap vector tiles (Liberty style) &bull; {stores.length} stores loaded
      </div>
    </div>
  );
}
